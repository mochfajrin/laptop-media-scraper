...
function getLaptops(): Array<Formatedlaptop> {
  const laptopsBuffer: Buffer = readFileSync("./data/laptops/link/laptop-media-link-list-4.json");
...
main("./data/laptops/results/laptop-media-full-spec-4.json", laptops, {
  verbose: true,
  override: true,
});
